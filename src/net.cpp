...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("OliTwistCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("OliTwistCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "OliTwistCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("OliTwistCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("OliTwistCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("OliTwistCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("OliTwistCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. OliTwistCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("OliTwistCoin-start");
