...
unsigned int nTargetSpacing = 1 * 30; // OliTwistCoin - 30 second blocks
...
const string strMessageMagic = "OliTwistCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 309600 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OliTwistCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Oliver Twist's workhouse to be converted to luxury flats – 15th July 2017";
        CTransaction txNew;
        txNew.nTime = 1500089225;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1500089225;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 2009867;
		if(fTestNet)
        {
            block.nNonce = 2009867;
        }
		
		uint256 nhashMerkleRoot = uint256("0xe24591187edf983a213e1817a90ac75b139d75415bf9e9decede99f81431d852");
...
unsigned char pchMessageStart[4] = { 0xc2, 0xb3, 0xa4, 0xd1 };
